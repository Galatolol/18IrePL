...
\begin{center}
  \begin{tabular}{ | c | c | c | c | c | c |}
    ...
    \cellcolor{yellow}2 & 80 & 7 & 2/- & - & Minor companies can open.  Yellow par values available.\\ \hline
    \cellcolor{green!50}3 & 180 & 4 & 2/4 & - & \multirow{2}{*}{\makecell{Minor companies can open. Yellow and green par values available.\\ Major companeis can form by merger. May buy private companies.}} \\ \cline{1-5}
    \cellcolor{green!50}4 & 300 & 3 & 2/3 & 2 &  \\ \hline
    \cellcolor{brown}5 & 440 & 2 & \multirow{3}{*}{1/2} & - & \multirow{2}{*}{\makecell{Minor companies can open.\\Yellow, green, and brown par values available.\\ Major companeis can form by merger. Private companies close.}} \\ \cline{1-3}\cline{5-5}
